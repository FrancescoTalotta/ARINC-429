...
- ESP-IDF build output: `build/`
- downloaded managed components: `managed_components/`
- clangd cache: `.cache/`
- Python bytecode: `__pycache__/`, `*.pyc`
- local captures/logs

Commit source files, `sdkconfig`, `dependencies.lock`, and documentation. Do not commit local captures or build products.
